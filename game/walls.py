...
class wall_creation():
    ...
    def __init__(self, screen) -> None:
        ...
        self._left_list = [57, 164, 354, 483, 57, 483, 164, 419, 164, 356, 164, 188, 225, 290, 419, 354, 225, 290, 57, 100, 483, 484, 57, 164, 225, 289, 354, 420, 0, 590, 480, 0, 0, 291, 324, 225, 227, 365, 241, 0, 0, 15, 5, 480, 590, 546, 547]
