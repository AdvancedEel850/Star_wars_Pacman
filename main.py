...
"""This file contols the main loop of the game. In this file, It inherits from the acarde.Window class to allow the game to run.
This file uses the principle of Abstration to create the sprites, and contol all of the sprite actions, all using functions in the arcade.Window class."""
    ...
    def on_update(self, delta_time: float):
        ...
        if len(self.dots) == 0:
            for n in range(0,len(self.ghost)):
                self.ghost[n].remove_from_sprite_lists()
                self.ghost.update()
                sleep(1)
